...
class Tasks {
    ...
    inner class Day18 {
        ...
        inner class Task2 {
            @Test
            fun solution() = testTask(days.day18.Task2(), "/day18/input", 60807587180737)
    ...
    inner class Day20 {
        ...
        inner class Task1 {
            @Test
            fun solution() = testTask(days.day20.Task1(), "/day20/input", 16937516456219)

            @Test
            fun example1() = testTask(days.day20.Task1(), "/day20/task1/example1", 20899048083289)
        }

        @Nested
        inner class Task2 {
            @Test
            fun solution() = testTask(days.day20.Task2(), "/day20/input", 1858)

            @Test
            fun example1() = testTask(days.day20.Task2(), "/day20/task2/example1", 273)
        }
    }
    ...
    inner class Day21 {
        ...
        inner class Task1 {
            @Test
            fun solution() = testTask(days.day21.Task1(), "/day21/input", 2556)

            @Test
            fun example1() = testTask(days.day21.Task1(), "/day21/task1/example1", 5)
        }
        ...
        inner class Task2 {
            @Test
            fun solution() =
                testTask(days.day21.Task2(), "/day21/input", "vcckp,hjz,nhvprqb,jhtfzk,mgkhhc,qbgbmc,bzcrknb,zmh")

            @Test
            fun example1() = testTask(days.day21.Task2(), "/day21/task2/example1", "mxmxvkd,sqjhc,fvjkl")
        }
    }
    ...
    inner class Day22 {
        ...
        inner class Task1 {
            @Test
            fun solution() = testTask(days.day22.Task1(), "/day22/input", 32272)
    ...
    inner class Day23 {
        ...
        inner class Task1 {
            @Test
            fun solution() = testTask(days.day23.Task1(), "/day23/input", 58427369)

            @Test
            fun example1() = testTask(days.day23.Task1(), "/day23/task1/example1", 67384529)
        }

        @Nested
        inner class Task2 {
            @Test
            fun solution() = testTask(days.day23.Task2(), "/day23/input", 111057672960)

            @Test
            fun example1() = testTask(days.day23.Task2(), "/day23/task2/example1", 149245887792)
        }
    }
    ...
    inner class Day24 {
        ...
        inner class Task1 {
            @Test
            fun solution() = testTask(days.day24.Task1(), "/day24/input", 341)

            @Test
            fun example1() = testTask(days.day24.Task1(), "/day24/task1/example1", 10)
        }

        @Nested
        inner class Task2 {
            @Test
            fun solution() = testTask(days.day24.Task2(), "/day24/input", 3700)

            @Test
            fun example1() = testTask(days.day24.Task2(), "/day24/task2/example1", 2208)
        }
    }
    ...
    inner class Day25 {
        ...
        inner class Task1 {
            @Test
            fun solution() = testTask(days.day25.Task1(), "/day25/input", 11576351)

            @Test
            fun example1() = testTask(days.day25.Task1(), "/day25/task1/example1", 14897079)
        }
    }
}
