...
func TestTask1(t *testing.T) {
	t.Run("Mock(data)", tests.RunTest(Task1, tests.MockData("data"), lo.Empty[types.Nil](), 24, false))
	t.Run("Real(day14)", tests.RunTest(Task1, tests.RealData("day14"), lo.Empty[types.Nil](), 799, false))
}
...
func TestTask2(t *testing.T) {
	t.Run("Mock(data)", tests.RunTest(Task2, tests.MockData("data"), lo.Empty[types.Nil](), 93, false))
	t.Run("Real(day14)", tests.RunTest(Task2, tests.RealData("day14"), lo.Empty[types.Nil](), 29076, false))
}
