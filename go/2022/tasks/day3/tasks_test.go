...
var taskDefinitions = []tests.TaskDefinition[int, types.Nil]{
	{
		...
		Tests: []tests.TestDefinition[int, types.Nil]{
			{Path: "data", Expected: 157, Type: tests.TestData},
			{Path: "day3", Expected: 8252, Type: tests.RealData},
		},
	},
	{
		Task: Task2,
		Tests: []tests.TestDefinition[int, types.Nil]{
			{Path: "data", Expected: 70, Type: tests.TestData},
			{Path: "day3", Expected: 2828, Type: tests.RealData},
		},
	},
}
