...
func TestTask1(t *testing.T) {
	t.Run("mock(data)", tests.RunTest(Task1, tests.MockData("data"), lo.Empty[types.Nil](), "CMZ", false))
	t.Run("real(day5)", tests.RunTest(Task1, tests.RealData("day5"), lo.Empty[types.Nil](), "SHQWSRBDL", false))
}
...
func TestTask2(t *testing.T) {
	t.Run("mock(data)", tests.RunTest(Task2, tests.MockData("data"), lo.Empty[types.Nil](), "MCD", false))
	t.Run("real(day5)", tests.RunTest(Task2, tests.RealData("day5"), lo.Empty[types.Nil](), "CDTQZHBRS", false))
}
