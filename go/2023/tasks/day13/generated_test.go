...
func TestTask1(t *testing.T) {
	t.Run("Mock(data)", tests.RunTest(Task1, tests.MockData("data"), lo.Empty[types.Nil](), 405, false))
	t.Run("Real(day13)", tests.RunTest(Task1, tests.RealData("day13"), lo.Empty[types.Nil](), 30802, false))
}
...
func TestTask2(t *testing.T) {
	t.Run("Mock(data)", tests.RunTest(Task2, tests.MockData("data"), lo.Empty[types.Nil](), 400, false))
	t.Run("Real(day13)", tests.RunTest(Task2, tests.RealData("day13"), lo.Empty[types.Nil](), 37876, false))
}
