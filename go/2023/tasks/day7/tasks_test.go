...
var taskDefinitions = []tests.TaskDefinition[int, types.Nil]{
	{
		...
		Tests: []tests.TestDefinition[int, types.Nil]{
			{Path: "data", Expected: 6440, Type: tests.TestData},
			{Path: "day7", Expected: 251216224, Type: tests.RealData},
		},
	},
	{
		Task: Task2,
		Tests: []tests.TestDefinition[int, types.Nil]{
			{Path: "data", Expected: 5905, Type: tests.TestData},
			{Path: "day7", Expected: 250825971, Type: tests.RealData},
		},
	},
}
