...
var taskDefinitions = []tests.TaskDefinition[int, types.Nil]{
	{
		...
		Tests: []tests.TestDefinition[int, types.Nil]{
			{Data: tests.MockData("data"), Expected: 6440},
			{Data: tests.RealData("day7"), Expected: 251216224},
		},
	},
	{
		Task: Task2,
		Tests: []tests.TestDefinition[int, types.Nil]{
			{Data: tests.MockData("data"), Expected: 5905},
			{Data: tests.RealData("day7"), Expected: 250825971},
		},
	},
}
