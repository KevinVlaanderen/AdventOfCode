...
func TestTask1(t *testing.T) {
	t.Run("Mock(data)", tests.RunTest(Task1, tests.MockData("data"), lo.Empty[types.Nil](), 114, false))
	t.Run("Real(day9)", tests.RunTest(Task1, tests.RealData("day9"), lo.Empty[types.Nil](), 1993300041, false))
}
...
func TestTask2(t *testing.T) {
	t.Run("Mock(data)", tests.RunTest(Task2, tests.MockData("data"), lo.Empty[types.Nil](), 2, false))
	t.Run("Real(day9)", tests.RunTest(Task2, tests.RealData("day9"), lo.Empty[types.Nil](), 1038, false))
}
