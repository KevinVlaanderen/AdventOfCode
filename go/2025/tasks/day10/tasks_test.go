...
var taskDefinitions = []tests.TaskDefinition[int, types.Nil]{
	{
		...
		Tests: []tests.TestDefinition[int, types.Nil]{
			{Path: "data", Expected: 7, Type: tests.TestData},
			{Path: "day10", Expected: 404, Type: tests.RealData},
		},
	},
	{
		Task: Task2,
		Tests: []tests.TestDefinition[int, types.Nil]{
			{Path: "data", Expected: 33, Type: tests.TestData},
			{Path: "day10", Expected: 16474, Type: tests.RealData},
		},
	},
}
