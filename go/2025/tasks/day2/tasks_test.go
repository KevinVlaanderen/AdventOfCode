...
var taskDefinitions = []tests.TaskDefinition[int, types.Nil]{
	{
		...
		Tests: []tests.TestDefinition[int, types.Nil]{
			{Data: tests.MockData("data"), Expected: 1227775554},
			{Data: tests.RealData("day2"), Expected: 54234399924},
		},
	},
	{
		Task: Task2,
		Tests: []tests.TestDefinition[int, types.Nil]{
			{Data: tests.MockData("data"), Expected: 4174379265},
			{Data: tests.RealData("day2"), Expected: 70187097315},
		},
	},
}
