...
func TestTask1(t *testing.T) {
	...
	t.Run("real(day4)", tests.RunTest(Task1, tests.RealData("day4"), lo.Empty[types.Nil](), 1491, false))
}
...
func TestTask2(t *testing.T) {
	t.Run("mock(data)", tests.RunTest(Task2, tests.MockData("data"), lo.Empty[types.Nil](), 43, false))
	t.Run("real(day4)", tests.RunTest(Task2, tests.RealData("day4"), lo.Empty[types.Nil](), 8722, false))
}
