...
let benchmarks = {
    ...
    Benchmark("Day17.Task2.data") { benchmark in
        benchmark.configuration.timeUnits = .microseconds
    ...
    Benchmark("Day20.Task1.data") { benchmark in
        benchmark.configuration.timeUnits = .microseconds
    ...
    Benchmark("Day20.Task2.data") { benchmark in
        benchmark.configuration.timeUnits = .microseconds
    ...
    Benchmark("Day21.Task1.data") { benchmark in
        benchmark.configuration.timeUnits = .microseconds
    ...
    Benchmark("Day21.Task2.data") { benchmark in
        benchmark.configuration.timeUnits = .microseconds
    ...
    Benchmark("Day22.Task1.data") { benchmark in
        benchmark.configuration.timeUnits = .microseconds
    ...
    Benchmark("Day22.Task2.data") { benchmark in
        benchmark.configuration.timeUnits = .microseconds
    ...
    Benchmark("Day23.Task1.data") { benchmark in
        benchmark.configuration.timeUnits = .microseconds
    ...
    Benchmark("Day23.Task2.data") { benchmark in
        benchmark.configuration.timeUnits = .microseconds
    ...
    Benchmark("Day24.Task1.data") { benchmark in
        benchmark.configuration.timeUnits = .microseconds
    ...
    Benchmark("Day24.Task2.data") { benchmark in
        benchmark.configuration.timeUnits = .microseconds
